...
public class CalendarView {
    ...
    public CalendarView(YearMonth month, Locale l) {
        view = new BorderPane();
        ...
        header.textProperty().bind(Bindings.createStringBinding(() -> 
            this.month.get().format(DateTimeFormatter.ofPattern("MMMM yyyy", l)), 
    ...
    public CalendarView(Locale l) {
        this(YearMonth.now(), l) ;
    }
    ...
    private void rebuildCalendar() {
        ...
        List<Appointment> multipleDayAppts = new ArrayList<>();        
